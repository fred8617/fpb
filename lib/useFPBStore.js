...
var useFPBStore = function useFPBStore(props) {
  ...
  var store = (0, _mobxReactLite.useLocalStore)(function (source) {
    return {
      ...
      setBreakpointConfig: function (_setBreakpointConfig) {
        function setBreakpointConfig(_x) {
          return _setBreakpointConfig.apply(this, arguments);
        }

        setBreakpointConfig.toString = function () {
          return _setBreakpointConfig.toString();
        };

        return setBreakpointConfig;
      }(function (values) {
      ...
      deleteItem: function deleteItem(key) {
        ...
        force(); // setTimeout(doWindowResize,300)
      },
      ...
      caclHeight: function caclHeight(height, key) {
        ...
        item.h = h || 30;
        item.maxH = item.h;
        item.minH = item.h; // debounce(doWindowResize,200)
      ...
      createItem: function createItem() {
        ...
        force(); // setTimeout(doWindowResize, 200);
      },
      editingItem: null,
