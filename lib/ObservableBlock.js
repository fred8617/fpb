...
var getComponent = function getComponent(props) {
  ...
  var component = store.flatComponents[componentId];
  ...
  var _toJS = (0, _mobx.toJS)(componentProps || {}, {
    ...
    rest = _objectWithoutProperties(_toJS, _excluded);
  ...
  var renderComponentChildren = function renderComponentChildren() {
    ...
    comp.componentProps.children.type === 'FPR' //子元素为数组
      ...
      var Comp = /*#__PURE__*/_react.default.createElement(_mobxReactLite.Observer, null, function () {
        return /*#__PURE__*/_react.default.createElement(_FPB.default, {
  ...
  //没有属性或者
  !component.componentProps.children ||
  //有属性没有子元素或者
  !component.componentProps.children.shouldHaveOne ||
  //或者有子元素不需要默认创建
  component.componentProps.children &&
  //有子元素并且需要有默认元素并且类型还是数组的需要长度大于0
  component.componentProps.children.shouldHaveOne && component.componentProps.children.type === 'array:component' && children && children.length) && /*#__PURE__*/_react.default.createElement(_ErrorWrapper.default, null, function (props) {
    ...
    return /*#__PURE__*/_react.default.createElement(Component, _extends({}, finalComponentProps, props), children && renderComponentChildren());
  });
};
/**
 * 观察者区块
 ...
 */
var ObservableBlock = /*#__PURE__*/_react.default.memo(function (props) {
  // useEffect(() => {
  //   console.log("mounted");
  // }, []);
  var store = props.store;
  ...
  return /*#__PURE__*/_react.default.createElement(_mobxReactLite.Observer, null, function () {
    ...
    return /*#__PURE__*/_react.default.createElement(_Block.default, {
      ...
      if (item.isFormField && finalComponent) {
        renderedComponent = /*#__PURE__*/_react.default.createElement(_FormConsumerComponent.default, {
          item: item,
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, renderedComponent);
    }));
  });
});
