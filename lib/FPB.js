...
var FPB = function FPB(props) {
  ...
  (0, _react.useEffect)(function () {}, [store.layouts]);
  ...
  (0, _react.useEffect)(function () {
    ...
    if (props.defaultDatas) {
      ...
      store.setBreakpointFromEntry(props.defaultDatas.breakpoints); // store.setLayouts([] as any, props.defaultDatas.layouts);
