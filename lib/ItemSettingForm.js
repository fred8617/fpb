...
var ItemSettingForm = function ItemSettingForm(props) {
  var form = props.form,
      item = props.item,
      onItemPropsChange = props.onItemPropsChange;
  console.log('ItemSettingForm', (0, _mobx.toJS)(props, {
  ...
  (0, _react.useEffect)(function () {
    //临时解决方案
    setTimeout(function () {
      return Object.keys(keyCounter).length && form.getFieldsValue().componentProps && form.setFieldsValue({
    ...
    return [].concat(_toConsumableArray(componentPropsEntries.filter(function (_ref3) {
      ...
      if (prop.type === 'string') {
        setting = _react.default.createElement(Item, {
          ...
          initialValue: (0, _get2.default)(item, propName)
        ...
        setting = _react.default.createElement(Item, {
          ...
          initialValue: (0, _mobx.toJS)((0, _get2.default)(item, propName), {
            recurseEverything: true
          })
      ...
      setting = _react.default.createElement(Panel, {
      ...
      }, "\u6DFB\u52A0", prop.label), prop.type === 'array:component' && _react.default.createElement(_reactBeautifulDnd.DragDropContext, {
        onDragEnd: sortProps
      ...
      })) || prop.type === 'array:string' && _react.default.createElement(_reactBeautifulDnd.DragDropContext, {
        onDragEnd: sortProps
      }, _react.default.createElement(_reactBeautifulDnd.Droppable, {
        droppableId: propName
      }, function (provided) {
        return _react.default.createElement("div", _extends({}, provided.droppableProps, {
          ...
          var key = "".concat(propName, "[").concat(pi, "]"); // console.log(key);
  ...
  var _useSizeMe = (0, _useSizeMe3.default)(function (size) {
    var width = size.width;
    return _react.default.createElement(_form.default, getFormItemCol(width), _react.default.createElement(_collapse.default, {
      accordion: true,
      defaultActiveKey: ['1'],
      destroyInactivePanel: false
      ...
      gutter: 15
    }, _react.default.createElement(_col.default, getCol(width, Size.MIDDLE), _react.default.createElement(Item, {
      label: '组件'
    ...
    }))))), _react.default.createElement(_col.default, getCol(width, Size.SMALL), _react.default.createElement(Item, {
      ...
      checkedChildren: '是',
      unCheckedChildren: '否'
    })))), isFormField && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_col.default, getCol(width, Size.MIDDLE), _react.default.createElement(Item, {
      ...
      _useSizeMe2 = _slicedToArray(_useSizeMe, 1),
      settingForm = _useSizeMe2[0];

  return _react.default.createElement(_react.default.Fragment, null, settingForm);
};
